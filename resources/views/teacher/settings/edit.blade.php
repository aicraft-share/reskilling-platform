    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <section>
                ...
                <form method="post" action="{{ route('teacher.settings.update-profile') }}" enctype="multipart/form-data" class="mt-6 space-y-6"
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <section>
                ...
                <form method="post" action="{{ route('teacher.settings.update-password') }}" class="mt-6 space-y-6"
                    @submit.prevent="submitForm">
                    @csrf
                    @method('patch')
        ...
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <section>
                ...
                <form method="post" action="{{ route('teacher.settings.update-notifications') }}"
                    ...
                    <div class="flex flex-col space-y-4">
                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_assignment_submitted" value="1" class="sr-only peer"
                                {{ old('notify_assignment_submitted', $user->notify_assignment_submitted) ? 'checked' : '' }}>
                            <div
                                class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                            </div>
                            <span
                                class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">新しい課題提出があった時</span>
                        </label>

                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_new_chat" value="1" class="sr-only peer" {{ old('notify_new_chat', $user->notify_new_chat) ? 'checked' : '' }}>
                            <div
                                class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                            </div>
                            <span
                                class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">生徒から新しいチャットが届いた時</span>
                        </label>

                        <label class="inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="notify_mtg_updated" value="1" class="sr-only peer" {{ old('notify_mtg_updated', $user->notify_mtg_updated) ? 'checked' : '' }}>
                            <div
                                class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600">
                            </div>
                            <span
                                class="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300">MTG関連の更新があった時</span>
                        </label>
                    </div>
